...
export function HeroSection() {
  return (
    <section className="relative min-h-[70vh] flex flex-col items-center justify-center px-6 overflow-hidden">
      ...
      >
        <motion.h1
          className="text-6xl md:text-8xl font-bold tracking-tight mb-4 bg-gradient-to-r from-gray-900 via-hinge-accent to-hinge-accent-light bg-clip-text text-transparent"
